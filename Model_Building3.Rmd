...
xi: svy,subpop(if include==1): mlogit BP_cat i.MJ2 gndr  ridageyr SMK_cat, rrr
```


```{r}
data.S <-  c(1.122802   ,1.260209   ,1.104195    ,.9903049,1.164193   ,1.044001   )
...
xi: svy,subpop(if include==1): mlogit BP_cat i.MJ2 gndr  ridageyr AL_cat, rrr
```

```{r}
data.Al <-  c(1.087775,1.194265,1.068571   ,.9754946,1.095751   ,1.024581)
...
Only BMI produced a mean change in RR greater than 10%; smoking and alcohol use produced a mean change in RR of less than 10%, but individual changes were greater than 10%; addition of healthy eating index did not produce any changes in RR greater than 10%.  Therefore model 3 will include tobacco use, alcohol use, and BMI, but not HEI.
