...
xi: svy,subpop(if include==1 & gndr==0): mlogit BP_cat i.MJ2 gndr ridageyr i.AL_cat bmxbmi, rrr
```
...
xi: svy,subpop(if include==1 & gndr==1): mlogit BP_cat i.MJ2 gndr ridageyr i.AL_cat bmxbmi, rrr
```
